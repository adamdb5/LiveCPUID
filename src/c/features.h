...
/* Standard Features */
#define MASK_RDRND 0x80000000
#define MASK_F16C 0x20000000
#define MASK_AVX 0x10000000
#define MASK_OSXSAVE 0x08000000
#define MASK_XSAVE 0x04000000
#define MASK_AESNI 0x02000000
#define MASK_TSCDEADLINE 0x01000000
#define MASK_POPCNT 0x00800000
#define MASK_MOVBE  0x00400000
#define MASK_X2APIC 0x00200000
#define MASK_SSE42 0x00100000
#define MASK_SSE41 0x00080000
#define MASK_DCA   0x00040000
#define MASK_PCID  0x00020000
#define MASK_PDCM  0x00008000
#define MASK_XTPR  0x00004000
#define MASK_CMPXCHG16B 0x00002000
#define MASK_FMA 0x00001000
#define MASK_CNXTID 0x00000400
#define MASK_SSSE3 0x00000200
#define MASK_TM2     0x00000100
#define MASK_EIST     0x00000080 
#define MASK_SMX     0x00000040
#define MASK_VMX     0x00000020
#define MASK_DSCPL   0x00000010 
#define MASK_MONITOR 0x00000008
#define MASK_DTES64  0x00000004 
#define MASK_PCLMULQDQ 0x00000002
#define MASK_SSE3 0x00000001

#define MASK_PBE 0x80000000 
#define MASK_TM  0x20000000 
#define MASK_HTT 0x10000000
#define MASK_SS  0x08000000
#define MASK_SSE2 0x04000000
#define MASK_SSE 0x02000000
#define MASK_FXSR 0x01000000
#define MASK_MMX 0x00800000
#define MASK_ACPI 0x00400000
#define MASK_DS  0x00200000
#define MASK_CLFSH 0x00080000
#define MASK_PSN   0x00040000 
...
#define MASK_SEP 0x00000800
#define MASK_APIC 0x00000200
#define MASK_CX8 0x00000100
